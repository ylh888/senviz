...
function setup() {
    ...
    // CONNECT_HUB, SHOW_DATA, SERVER_PORT are all set in the next call
    set_app_mode(AS_CLIENT)
    ...
    */
    ...
    if (DEV) { // if not DEV, then using hardcoded value from utils?.js
...
function draw() {
    ...
    textAlign(LEFT);
    textSize(12);
    text('access code ' + accessCode, 24, C_HEIGHT - 180)
